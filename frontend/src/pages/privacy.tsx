...
export default function Privacy() {
  const sections = [
    { title: 'What we collect', content: 'Wary processes text or images you submit for analysis. Content is analysed in real time and is not stored, logged, or retained after analysis.' },
